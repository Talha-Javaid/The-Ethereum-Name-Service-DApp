...
export default function Home() {
  ...
  */
  ...
  return (
    <div>
      <Head>
        <title>Beyond MetaVerse ENS DAPP</title>
        <meta name="description" content="Beyond MetaVerse ENS DAPP" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>
            Welcome to Beyond MetaVerse! {ens ? ens : address}!
          </h1>
          <div className={styles.description}>
            Its an NFT collection for Beyond MetaVerse Punks.
          </div>
          {renderButton()}
        </div>
        <div>
